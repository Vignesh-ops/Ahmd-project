...
export default function Navbar({ user }) {
  ...
  return (
    ...
    <header
      className="sticky top-0 z-30 border-b border-black/5 bg-white dark:border-white/5 dark:bg-dark-base"
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 pt-[env(safe-area-inset-top)] sm:px-6 sm:py-4">
