...
export default function Navbar({ user }) {
  ...
  return (
    ...
    <header
      className="sticky top-0 z-30 border-b border-white/5 bg-dark-base backdrop-blur-xl"
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 pt-[max(env(safe-area-inset-top),12px)] sm:px-6 sm:py-4">
