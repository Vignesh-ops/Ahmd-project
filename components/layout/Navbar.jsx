...
export default function Navbar({ user }) {
  ...
  return (
    ...
    <header className="top-navbar sticky top-0 z-30 border-b border-white/5 bg-dark-base/95 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-4">
        <AppLink href="/" prefetch={false} refreshOnNavigate className="flex min-w-0 items-center gap-3">
