...
export default function PullToRefresh() {
  ...
  return (
    ...
    >
      <div className="pull-refresh-indicator inline-flex min-h-[44px] items-center gap-2 rounded-2xl border border-white/10 bg-dark-elevated/95 px-4 py-2 text-xs font-semibold text-white shadow-glow backdrop-blur">
        {refreshing ? (
