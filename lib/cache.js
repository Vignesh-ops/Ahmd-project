...
import { getAdminSummary, getCombinedOrdersPage, getDailyOrderTrend, getOrderByOrderNo } from "./orders";
...
export const getCachedDailyOrderTrend = unstable_cache(
  async (days) => getDailyOrderTrend({ days }),
  ["daily-order-trend"],
  { tags: [CACHE_TAGS.orders], revalidate: SHORT_TTL_SECONDS }
);
