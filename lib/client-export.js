...
async function saveAndShareFile(filename, data, mimeType) {
...
export function exportCsv(filename, rows) {
  ...
  if (canUseNativeShare()) {
    ...
    void saveAndShareFile(filename, data, "text/csv");
    return;
  }
...
export async function exportXlsx(filename, rows, sheetName = "Report") {
  ...
  if (canUseNativeShare()) {
    ...
    await saveAndShareFile(filename, data, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
    return;
  }
